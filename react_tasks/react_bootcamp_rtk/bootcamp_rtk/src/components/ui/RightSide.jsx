...
const RightSide = () => {
    ...
    const mycourse = useSelector((state)=>state.app.mycourse)     // here will have 
    // console.log(mycourse);
    const courses = useSelector((state)=>state.app.course_array)   // particular courses for a related category
    const userlogin = useSelector((state)=>state.app.userlogin)    // If user login we will add the particular course in whishlist for a particular user
