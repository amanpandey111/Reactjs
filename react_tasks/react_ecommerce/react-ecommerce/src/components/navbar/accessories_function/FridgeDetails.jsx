...
const FridgeDetails = () => {
    ...
    const{fridge,handleIncrement} = useContext(DataProvider)
    console.log(data);
    console.log(fridge);
    const displayData = fridge.filter((curEle)=>{
        return curEle.id===data
    })
    console.log(displayData);
    return (
        <>
        <section className='dynamic-fridge-main'>
        <section className='dynamic-fridge-section'>
            <div className='dynamic-fridge-div1'>
                <form action="">
                        {
                        fridge.map((curEle)=>{
                            return(
            ...
            <div className='dynamic-fridge-div2'>
