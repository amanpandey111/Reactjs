...
const MenWearDetails = () => {
  const{addCartData} = useContext(DataProvider)
    ...
    const{menwear,handleIncrement} = useContext(DataProvider)
    const displayData = menwear.filter((curEle)=>{
        return curEle.id===data
    })
  return (
    <>
        <section className='dynamic-men-main'>
        <section className='dynamic-menwear-section'>
            <div className='dynamic-menwear-div1'>
                <form action="">
                        {
                        menwear.map((curEle)=>{
                            return(
            ...
            <div className='dynamic-menwear-div2'>
                <aside className='menwear-aside' >
