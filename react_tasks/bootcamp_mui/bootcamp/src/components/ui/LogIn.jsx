...
const LogIn = () => {
    ...
    const handleInputChange = (e)=> {
        ...
        let error1 = handleError(name,value,error)
        setError(error1)
    }
    const handleError = (name,value,error)=> {
  ...
  return (
        ...
        sx={{bgcolor:"white",alignItems:"center",gap:"1rem",borderRadius:"2.5rem",p:"2rem 0rem",position:"absolute",top:"50%",right:"50%",transform:"translate(50%,70%)",width:"30rem"}}
        >
            ...
            <Box component="form" sx={{display:"flex",flexDirection:"column",alignItems:"center",gap:"1rem"}} onSubmit={handleFormSubmit} >
                ...
                sx={{width:"70%",borderRadius:"0.3rem",fontFamily:"sans-serif"}}
                >Sign in</Button>
            </Box>
        </Stack>
  )
