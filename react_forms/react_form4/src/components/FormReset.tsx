...
const FormReset = () => {
    ...
    const {register,reset,control,watch,setValue,getValues,handleSubmit,trigger,formState:{errors,touchedFields,dirtyFields,isDirty,isValid,isSubmitting,isSubmitted,isSubmitSuccessful,submitCount}} = form
    ...
    const handleReset = () => {
        console.log("let's reset values");
        reset()
    }
    const handleValidate = () => {
        // trigger()   //! trigger all fields validation
        // trigger("email")  //! triger only email field validation
        trigger(["name","email"])  //! trigger more than one field 
    }
  return (
    <>
        <div className='userFrom'>
            ...
            <form action="#" className='userDetailForm' onSubmit={handleSubmit(formSubmit, onError)} >
                    ...
                    <input autoComplete='true' id="email" type="email" {...register('email',{
                        ...
                        validate:{
                             checkValidationEmail : async(value) => {
                                ...
                                return res && res.length === 0 || "this email is already taken"
                             }
                        }
                ...
                <div className='fromGroup'>
                    ...
                    <button type='button' onClick={handleReset} >Reset Value</button>
