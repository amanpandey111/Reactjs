...
const FormSubmit = () => {
    ...
    const {register,control,watch,setValue,getValues,handleSubmit,formState:{errors,touchedFields,dirtyFields,isDirty,isValid,isSubmitting,isSubmitted,isSubmitSuccessful,submitCount}} = form
