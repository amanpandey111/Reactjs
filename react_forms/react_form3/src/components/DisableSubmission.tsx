...
const DisableSubmission = () => {
    ...
    const {register,control,watch,setValue,getValues,handleSubmit,formState:{errors,touchedFields,dirtyFields,isDirty,isValid}} = form
...
export default DisableSubmission