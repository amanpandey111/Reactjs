    ...
    const handleInputChange = (e) => {
        ...
        if(value==" "){
            ...
            if(name=="phone"){
                ...
                //     if(value=="91"){
                //         console.log("sorry starts with 91");
                ...
                //         setError((prev)=>({...prev,phone:"should starts with 91"}))
                //     }
                // }
                if(value.length==1){
  ...
  return (
    <div className="container addnewstudent">
        ...
        <form onSubmit={handleFormSubmit}>
            ...
            <label>Name:</label> <br />
            <input type="text" id="id" name="name" required autoComplete="off" value={updatedata.name} onChange={handleInputChange} /> <br />
