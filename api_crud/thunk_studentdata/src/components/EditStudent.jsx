...
import { deleteStudent, fetchStudent, storeStudent, updateStudent } from "../reduxtoolkit/StudentSlice";
...
const EditStudent = () => {
  ...
  useEffect(()=>{         
    dispatch(fetchStudent())                                         //! whenever render getting the current id data
    getUserData()
  },[])
    ...
    const handleFormSubmit = (e) => {
        ...
        console.log(e1);
        if(!e1.length>=1){
            // dispatch(updateStudent({studentid,updatedata}))
            // navigate("/")
