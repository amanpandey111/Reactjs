...
const Home = () => {
  return (
    <main>
      <section className="section-hero bg-light py-5">
        <div className="container mb-3">
          <div className="row align-items-center home-main">
            <div className="col-md-6 home-main-first">
              <div className="section-hero--content">
                    <p className="hero-subheading text-muted">
                    Explore the Latest in Movie Industries
                    </p>
                    <h1 className="hero-heading display-4 text-primary">
                    Unlimited Movie, TV Shows, & More.
                    </h1>
                    <p className="hero-para text-dark">
